...
/* SpxMainBundle:Produits:topdec-xl.html.twig */
class __TwigTemplate_6af8928c5b74a7dac7f121b2149e2d1225bf80469bfef6b0ae809b79d7b8a743 extends Twig_Template
{
    ...
    public function block_modele($context, array $blocks = array())
    {
        // line 4
        echo "
<h2>Sparxs annonce le lancement de son bloc de combustion Topdeck \"XL\"</h2>
<h3>Tous les avantages, la sécurité et les fonctionnalités du best-seller Topdeck avec une largeur de flamme extra large augmentée de 60%</h3>
<div align=\"center\">
\t<img src=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("img/Produits/Topdec-xl.jpg"), "html", null, true);
        echo "\" alt\"topdec extra large\">
</div>
<h4>Design épuré:</h4>
<ul>
\t<li>le bloc de combustion bio-éthanol TOPDEC XL s'intègre\"flush\", c'est à dire affleurant au niveau de la structure le recevant</li>
...
<ul>
\t<li>Le réservoir amovible permet un remplissage à distance du bio-éthanol à la fois plus aisé et sans risque de débordement à proximité du foyer</li>
...
<ul>
\t<li>le bloc de combustion pour cheminées bio-éthanol TOPDEC XL reprend tous les points de la norme de sécurité NF D35-386</li>
...
";
    ...
    {
        return "SpxMainBundle:Produits:topdec-xl.html.twig";
    }
